...
export function CoursesClient({ userRole }: CoursesClientProps) {
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">
            {canCreateEdit ? 'Course Management' : 'Courses Overview'}
          </h1>
          <p className="text-gray-600 mt-1">
            {canCreateEdit 
              ? 'Manage your language learning courses across French, German, and Spanish'
              : 'Browse and view language learning courses across French, German, and Spanish'
            }
          </p>
        </div>
        {canCreateEdit && (
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-green-600">
                  {courses.filter((c: Course) => c.is_published).length}
                </p>
              </div>
